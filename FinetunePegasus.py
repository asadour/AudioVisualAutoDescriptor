...
from transformers import Seq2SeqTrainer, Seq2SeqTrainingArguments, DataCollatorForSeq2Seq, PegasusTokenizer, \
...
class FineTunePegasus:
    ...
    def compute_metrics(self, eval_pred):
        ...
        result = self.rouge_score.compute(predictions=decoded_preds, references=decoded_labels, use_stemmer=False)
